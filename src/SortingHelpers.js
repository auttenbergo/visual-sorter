...
// Quick Sort Helper
async function partition(arr, low, high, setArray, speed, getCancelled) {
    let pivot = arr[high];
    let i = low - 1;
...
// Quick Sort
export async function quickSort(arr, setArray, speed, low = 0, high = null, getCancelled) {
    ...
    if (low < high) {
        let pi = await partition(arr, low, high, setArray, speed, getCancelled);
        await quickSort(arr, setArray, speed, low, pi - 1, getCancelled);
        await quickSort(arr, setArray, speed, pi + 1, high, getCancelled);
    }
}
